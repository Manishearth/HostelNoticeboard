...
/* define if bf526_ezkit is enabled */
#define ENABLE_BUS_BF526_EZKIT 1

/* define if bf527_ezkit is enabled */
#define ENABLE_BUS_BF527_EZKIT 1

/* define if bf533_ezkit is enabled */
#define ENABLE_BUS_BF533_EZKIT 1

/* define if bf533_stamp is enabled */
#define ENABLE_BUS_BF533_STAMP 1

/* define if bf537_ezkit is enabled */
#define ENABLE_BUS_BF537_EZKIT 1

/* define if bf537_stamp is enabled */
#define ENABLE_BUS_BF537_STAMP 1

/* define if bf538f_ezkit is enabled */
#define ENABLE_BUS_BF538F_EZKIT 1

/* define if bf548_ezkit is enabled */
#define ENABLE_BUS_BF548_EZKIT 1

/* define if bf561_ezkit is enabled */
#define ENABLE_BUS_BF561_EZKIT 1
...
#define ENABLE_LOWLEVEL_FTD2XX 1
